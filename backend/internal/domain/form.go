...
type Form struct {
	...
	ExamSettings *ExamSettings `gorm:"foreignKey:FormID;constraint:OnDelete:CASCADE" json:"exam_settings,omitempty"`
...
type ExamSettings struct {
	...
	DurationMinutes    int        `gorm:"type:int;default:0" json:"duration_minutes"`
	MaxSubmissions     int        `gorm:"type:int;default:0" json:"max_submissions"`
	Passcode           string     `gorm:"type:varchar(50)" json:"passcode"`
