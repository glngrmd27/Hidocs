...
const defaultForms = [

  {
    ...
    description:
      "Bagikan pendapatmu mengenai pengalaman dan pelayanan kampus.",
...

  {
    ...
    description:
      "Uji pemahamanmu mengenai dasar-dasar pengembangan Flutter.",
...

  {
    ...
    description:
      "Daftarkan dirimu untuk mengikuti kegiatan Hackathon HiDocs.",
  ...
  const getStatusInformation = (
    ...
    if (
      ...
      return {
        ...
        description:
          "You have already submitted this form. You can still view the form details.",
