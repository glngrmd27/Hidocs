...
const defaultForms = [

  {
    ...
    description:
      "Please read all information carefully before filling out this survey.",
...

  {
    ...
    description:
      "Please read all information carefully before starting the quiz.",
...

  {
    ...
    description:
      "Please read all information carefully before registering for this event.",
...
const getScheduleStatus = (
  ...
  return {
    ...
    message:
      "This form is currently open and accepting responses.",
