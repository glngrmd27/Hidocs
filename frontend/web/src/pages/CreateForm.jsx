        ...
        <div className="visibility-options">
          ...
          {[

            {
              ...
              description:
                "The form automatically appears on the user dashboard and Forms page.",

              information:
                "Suitable for forms that should be visible to every user.",
            },

            {
              ...
              description:
                "The form stays hidden and can only be opened using its QR code or direct link.",

              information:
                "Suitable for private events or limited participants.",
            },
        ...
        <section className="settings-section">
          ...
          {[
...

            {
              ...
              description:
                "Respondents can see the result without the score.",
            },

            {
              ...
              description:
                "Respondents can see both their result and final score.",
            },
